...
<link rel="stylesheet" type="text/css" href="${path}/resources/css/product/product_order.css">
<div class="container">
<section class="cart">
    ...
    <div class="payment_progress">
        ...
        <div class="payment_final">
            ...
            <div class="cart__mainbtns">
                ...
                <button class="btn btn-primary py-1">결제하기</button>
            </div>
        </div>
    </section>
</div>
