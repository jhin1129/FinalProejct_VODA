...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="search1 row my-4">
            <div class="col-7 row">
<%--               <form action="${ path }/admin/admin_notice_search" method="GET"> --%>
		        ...
		        <div class="col-xs-7 col-sm-7 pl-0">
		            <div class="input-group">
		                 ...
		                 <span class="input-group-btn">
		                      <button id="searchBtn" name="searchBtn" class="btn btn-greyc text-nowrap" style="box-shadow: rgb(0 0 0 / 30%) 0px 0px 4px 0px;">
